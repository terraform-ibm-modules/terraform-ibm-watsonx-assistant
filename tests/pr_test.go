...
func TestRunBasicExample(t *testing.T) {
	...
	options := setupOptions(t, "wxa-basic", basicExampleDir)
		...
		if assert.Nil(t, tfOutputsErr, tfOutputsErr) {
			options := testhelper.TestOptionsDefault(&testhelper.TestOptions{
				...
				TerraformVars: map[string]interface{}{
					"existing_watsonx_assistant_instance_crn": terraform.OutputContext(t, context.Background(), existingTerraformOptions, "crn"),
				},
			})
			output, err := options.RunTestConsistency()
			assert.Nil(t, err, "This should not have errored")
...
func setupFullyConfigurableOptions(t *testing.T, prefix string) *testschematic.TestSchematicOptions {
	...
	options.TerraformVars = []testschematic.TestSchematicTerraformVar{
		...
		{Name: "plan", Value: "plus", DataType: "string"},
...
func TestRunFullyConfigurableSchematics(t *testing.T) {
	...
	options := setupFullyConfigurableOptions(t, "wxa-da")
...
func TestRunFullyConfigurableUpgradeSchematics(t *testing.T) {
	...
	options := setupFullyConfigurableOptions(t, "wxa-upg")
...
func TestDefaultConfiguration(t *testing.T) {
	...
	options.AddonConfig = cloudinfo.NewAddonConfigTerraform(
		options.Prefix,
		"deploy-arch-ibm-watsonx-assistant",
		"fully-configurable",
